...
while True:
    ...
    if times == 0:
        ...
        if option == "1":
            ...
            # Prints the amount of watch time for newly added channel.
            print(str(user_input) + ": " + str(channels[user_input]))
        ...
        if option == "2":
            ...
            if str(pickle.load(open("savedchanneldata.dat", "rb"))) is "":
                ...
                loaded_save_data = pickle.load(open("savedchanneldata.dat", "rb"))
                print(loaded_save_data)
